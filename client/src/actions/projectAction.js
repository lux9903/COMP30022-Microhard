...
export const {
  ...
  createProjectContributorStarted,
  createProjectContributorSuccess,
  createProjectContributorFailure,
  deleteProjectContributorStarted,
  deleteProjectContributorSuccess,
  deleteProjectContributorFailure,
  
  createProjectProcessStarted,
  createProjectProcessSuccess,
  createProjectProcessFailure,
  updateProjectProcessStarted,
  updateProjectProcessSuccess,
  updateProjectProcessFailure,
  deleteProjectProcessStarted,
  deleteProjectProcessSuccess,
  deleteProjectProcessFailure,

  createProjectNodeStarted,
  createProjectNodeSuccess,
  createProjectNodeFailure,
  updateProjectNodeStarted,
  updateProjectNodeSuccess,
  updateProjectNodeFailure,
  deleteProjectNodeStarted,
  deleteProjectNodeSuccess,
  deleteProjectNodeFailure,
  finishProjectNodeStarted,
  finishProjectNodeSuccess,
  finishProjectNodeFailure,

  createProjectTimelineStarted,
  createProjectTimelineSuccess,
  createProjectTimelineFailure,
  updateProjectTimelineStarted,
  updateProjectTimelineSuccess,
  updateProjectTimelineFailure,
  deleteProjectTimelineStarted,
  deleteProjectTimelineSuccess,
  deleteProjectTimelineFailure,
